...
PRODUCT_COPY_FILES := \
    ...
    $(COMMON_ROOTDIR)/system/vendor/bin/set-macaddr:system/vendor/bin/set-macaddr \
    $(COMMON_ROOTDIR)/system/etc/audio_policy.conf:system/etc/audio_policy.conf \
    $(COMMON_ROOTDIR)/system/vendor/etc/audio_effects.conf:system/vendor/etc/audio_effects.conf \
    $(COMMON_ROOTDIR)/system/etc/bluetooth/bt_vendor.conf:system/etc/bluetooth/bt_vendor.conf

# Logs
PRODUCT_COPY_FILES += \
    $(COMMON_ROOTDIR)/akmsg.sh:root/sbin/akmsg.sh \
    $(COMMON_ROOTDIR)/alogcat.sh:root/sbin/alogcat.sh \
    $(COMMON_ROOTDIR)/aradio.sh:root/sbin/aradio.sh
...
# These are the software-specific permissions
PRODUCT_COPY_FILES += \
